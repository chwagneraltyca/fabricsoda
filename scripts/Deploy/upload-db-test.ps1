# Upload db_test notebook to Fabric workspace
...
Write-Host "Uploading db_test notebook..." -ForegroundColor Cyan
...
$existing = $items.value | Where-Object { $_.displayName -eq "db_test" }

# Read notebook content
$notebookPath = Join-Path $PSScriptRoot ".." ".." "src" "Notebook" "db_test.ipynb"
