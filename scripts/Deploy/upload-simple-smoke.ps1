# Upload smoke_test_simple notebook to Fabric workspace
...
Write-Host "Uploading smoke_test_simple notebook..." -ForegroundColor Cyan
...
$existing = $items.value | Where-Object { $_.displayName -eq "smoke_test_simple" }

# Read notebook content
$notebookPath = Join-Path $PSScriptRoot ".." ".." "src" "Notebook" "smoke_test_simple.ipynb"
